# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-tcod
#
...
release = aiida_tcod.__version__
...
html_use_opensearch = 'http://aiida-tcod.readthedocs.io'
...
htmlhelp_basename = 'aiida-tcod-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_tcod')

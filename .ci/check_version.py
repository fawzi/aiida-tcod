...
Check version number in setup.json and aiida_tcod/__init__.py and make sure
they match.
"""
...
import aiida_tcod  # pylint: disable=wrong-import-position
version = aiida_tcod.__version__
